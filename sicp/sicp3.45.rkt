...
;Since serialized-exchanged takes both serializers and wraps the exchange call on them, each serializer for the accounts is called twice.  It's unclear, but since the serializer is already called once, the second call will be deadlocked.