...
;Another option is to make these procedures generic, but by doing so, each of the packages will have to 
;implement them.  Since all of the other representations are the same, it may not make sense to do so.