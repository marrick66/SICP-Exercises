...
;It seems as even though you protect the balance in a procedure, the serialization only lasts until the procedure
;completes, then the lock is released. So, it doesn't seem very beneficial unless you can serialize the procedure that uses the balance.